...
Content`,
		...
		it(`should auto-discover root markdown skills from ${CONFIG_DIR_NAME} skill dirs`, async () => {
...
Content`,
		...
		it(`should resolve project paths relative to ${CONFIG_DIR_NAME}`, async () => {
...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		...
		it(`should use the project ${CONFIG_DIR_NAME} dir as baseDir for project skills`, async () => {
	...
	describe("ignore files", () => {
		...
		it(`should not apply parent .gitignore to ${CONFIG_DIR_NAME} auto-discovery`, async () => {
	...
	describe("command spawning", () => {
		it("should preserve argv entries containing spaces", () => {
			...
			const valueWithSpace = `C:\\Users\\A B\\${CONFIG_DIR_NAME}\\npm`;
	...
	describe("settings source normalization", () => {
		...
		it(`should store project local packages relative to ${CONFIG_DIR_NAME} settings base`, () => {
